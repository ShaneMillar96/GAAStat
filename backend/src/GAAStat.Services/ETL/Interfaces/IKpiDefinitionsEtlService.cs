...
/// </summary>
public interface IKpiDefinitionsEtlService
{
    /// <summary>
    /// Executes the complete ETL pipeline for KPI definitions.
    /// Reads "KPI Definitions" sheet, validates data, and loads into the database.
    /// </summary>
    ...
    Task<KpiEtlResult> ProcessKpiDefinitionsAsync(
        string filePath,
